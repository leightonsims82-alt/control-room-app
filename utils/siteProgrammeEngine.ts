...
export const TRADE_ORDER = ['Groundworks', 'Brickwork', 'Bricklayer', 'Scaffold', 'Scaffolder', 'Roof', 'Roofer', 'Windows', 'Solar Panels Installer', 'Carpenter', 'Plumber', 'Electrician', 'Tiler', 'Sprinkler', 'Dry Liner', 'DRY LINER', 'Plastering', 'Kitchen Fitter', 'Decorator', taskCode('M', 'astic'), 'Mastic', 'Flooring', 'Cleaning', 'Handover / Site Team'] as const;
...
export const BUILD_SEQUENCE: ProgrammeActivity[] = [
  ...
  a(10, '3RD Lift Brickwork', 'Bricklayer', '3rd BWK', 10, 10, 1, 4),
  a(11, '3RD SCAFF', 'Scaffolder', '3rd Lift', 3, 11, 3, 4),
  a(12, '4TH Lift Brickwork', 'Bricklayer', '4th BWK', 3, 12, 1, 4),
  a(13, '4TH SCAFF', 'Scaffolder', '4th Lift', 2, 12, 4, 4),
  a(14, 'TRUSS', 'Carpenter', 'Truss', 3, 13, 1, 5),
  a(15, 'GABLES 1', 'Bricklayer', 'Gables', 1, 13, 4, 5),
  a(16, 'HOP UPS', 'Scaffolder', 'Hop Ups', 1, 13, 5, 5),
  ...
  a(21, 'TILE', 'Roofer', 'Tile', 2, 14, 5, 5),
  a(22, taskCode('STR', 'IP BC'), 'Scaffold', taskCode('Str', 'ip BC'), 1, 15, 1, 5),
  a(23, 'WINDOWS', 'Windows', 'Windows', 2, 15, 2, 6),
  a(24, '1ST FIX CARP', 'Carpenter', '1st Fix', 5, 15, 4, 6),
  a(25, '1ST FIX PLUMB', 'Plumber', '1st Fix', 2, 16, 4, 6),
  a(26, '1ST FIX ELEC', 'Electrician', '1st Fix', 2, 17, 1, 6),
  a(27, '1ST FIX SPRINKLER', 'Sprinkler', '1st Fix', 1, 17, 3, 6),
  a(28, 'PRE-PLASTER QA', 'Handover / Site Team', 'PP', 1, 17, 4, 6),
  a(29, 'TAC', 'DRY LINER', 'TAC', 5, 18, 1, 6),
  a(30, 'DAB', 'DRY LINER', 'Dab', 2, 18, 2, 6),
  a(31, 'TAPE', 'DRY LINER', 'Tape', 4, 18, 4, 6),
  a(32, 'DRY', 'Dry Liner', 'Sand', 3, 19, 3, 6),
  a(33, '2ND CARP', 'Carpenter', '2nd Fix', 5, 20, 1, 7),
  a(34, '2ND PLUMB', 'Plumber', '2nd Fix', 2, 21, 1, 7),
  a(35, '2ND ELEC', 'Electrician', '2nd Fix', 2, 21, 3, 7),
  a(36, 'WALL TILING', 'Tiler', 'Wall Tiling', 2, 22, 1, 7),
  a(37, 'KITCHEN', 'Kitchen Fitter', 'Kitchen', 3, 22, 3, 7),
  a(38, 'PATCH', 'Dry Liner', 'Patch', 3, 23, 1, 8),
  a(39, 'DEC', 'Decorator', 'Decorate', 8, 23, 4, 8),
  a(40, 'CARP FINALS', 'Carpenter', 'Finals', 2, 25, 2, 9),
  a(41, 'PLUMB FINALS', 'Plumber', 'Finals', 2, 25, 4, 9),
  a(42, 'FINAL DEC', 'Decorator', 'Final Dec', 5, 26, 1, 9),
  a(43, 'ELEC FINALS', 'Electrician', 'Finals', 2, 26, 3, 9),
  a(44, 'BUILD CLEAN', 'Cleaning', 'Build Clean', 1, 26, 5, 9),
  a(45, taskCode('MAS', 'TIC'), 'Mastic', 'Mastic', 1, 27, 1, 9),
  a(46, 'FLOORING', 'Flooring', 'Flooring', 4, 27, 2, 9),
  a(47, 'RE CLEAN', 'Cleaning', 'Re Clean', 2, 28, 1, 9),
  a(48, 'SPARKLE', 'Cleaning', 'Sparkle', 2, 28, 3, 9),
  a(49, 'PRE HANDOVER', 'Handover / Site Team', 'Pre Handover', 2, 28, 5, 9),
];