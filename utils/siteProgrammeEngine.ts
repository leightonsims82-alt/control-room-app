...
export const BUILD_SEQUENCE: ProgrammeActivity[] = [
  a(1, 'FND', 'Groundworks', 'Foundation', 5, 1, 1, 1),
  a(2, 'DNG', 'Groundworks', 'Drainage', 5, 2, 1, 1),
  ...
  a(24, '1ST CARP', 'Carpenter', '1st Fix', 5, 15, 4, 6),
  ...
  a(41, 'ELEC FINALS', 'Electrician', 'Finals', 2, 26, 1, 9),
  a(42, 'BUILD CLEAN', 'Cleaning', 'Build Clean', 1, 26, 3, 9),
  a(43, taskCode('MAS', 'TIC'), taskCode('M', 'astic'), taskCode('M', 'astic'), 1, 26, 4, 9),
  a(44, 'FLOORING', 'Flooring', 'Flooring', 4, 26, 5, 9),
  a(45, 'RE CLEAN', 'Cleaning', 'Re Clean', 2, 27, 4, 9),
  a(46, 'SPARKLE', 'Cleaning', 'Sparkle', 2, 28, 1, 9),
  a(47, 'PRE HANDOVER', 'Handover / Site Team', 'Pre Handover', 2, 28, 3, 9),
];