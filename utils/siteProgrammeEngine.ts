...
export const BUILD_SEQUENCE: ProgrammeActivity[] = [
  ...
  a(15, 'HOP UPS', 'Scaffold', 'Hop Ups', 1, 13, 4, 5),
  a(16, 'GABLES 2', 'Brickwork', 'Gables', 1, 13, 5, 5),
  a(17, 'SS', 'Roof', 'SS', 2, 14, 1, 5),
  a(18, 'F&B', 'Roof', 'F&B', 2, 14, 2, 5),
  a(19, 'SOLAR', 'Solar Panels Installer', 'Solar', 1, 14, 3, 5),
  a(20, 'TILE', 'Roof', 'Tile', 2, 14, 4, 5),
  a(21, taskCode('STR', 'IP BC'), 'Scaffold', taskCode('Str', 'ip BC'), 1, 14, 5, 5),
  a(22, '1ST CARP', 'Carpenter', '1st Fix', 5, 15, 1, 6),
  a(23, '1ST PLUMB', 'Plumber', '1st Fix', 2, 15, 2, 6),
  a(24, '1ST ELEC', 'Electrician', '1st Fix', 2, 15, 3, 6),
  a(25, '1ST SPRINKLER', 'Sprinkler', '1st Fix', 1, 15, 5, 6),
  a(26, 'PP', 'Plastering', 'PP', 3, 16, 1, 6),
  a(27, 'DAB', 'Plastering', 'Dab', 2, 16, 4, 6),
  a(28, 'TAPE', 'Plastering', 'Tape', 4, 17, 1, 6),
  a(29, 'DRY', 'Dry Liner', 'Dry', 3, 17, 5, 6),
  a(30, '2ND CARP', 'Carpenter', '2nd Fix', 5, 18, 3, 7),
  a(31, '2ND PLUMB', 'Plumber', '2nd Fix', 2, 19, 3, 7),
  a(32, '2ND ELEC', 'Electrician', '2nd Fix', 2, 19, 4, 7),
  a(33, 'WALL TILING', 'Tiler', 'Wall Tiling', 2, 20, 1, 7),
  a(34, 'KITCHEN', 'Kitchen Fitter', 'Kitchen', 3, 20, 3, 7),
  a(35, 'PATCH', 'Dry Liner', 'Patch', 3, 21, 1, 8),
  a(36, 'DEC', 'Decorator', 'Decorate', 8, 21, 4, 8),
  a(37, 'CARP FINALS', 'Carpenter', 'Finals', 2, 23, 3, 9),
  a(38, 'PLUMB FINALS', 'Plumber', 'Finals', 2, 23, 5, 9),
  a(39, 'ELEC FINALS', 'Electrician', 'Finals', 2, 24, 2, 9),
  a(40, 'FINAL DEC', 'Decorator', 'Final Dec', 5, 24, 4, 9),
  a(41, 'BUILD CLEAN', 'Cleaning', 'Build Clean', 1, 25, 4, 9),
  a(42, taskCode('MAS', 'TIC'), taskCode('M', 'astic'), taskCode('M', 'astic'), 1, 25, 5, 9),
  a(43, 'FLOORING', 'Flooring', 'Flooring', 4, 26, 1, 9),
  a(44, 'SPARKLE', 'Cleaning', 'Sparkle', 2, 26, 5, 9),
  a(45, 'PRE HANDOVER', 'Handover / Site Team', 'Pre Handover', 2, 27, 2, 9),
];