...
const stageRows: BedroomStageRow[] = [
  ...
  { name: 'Fourth lift brickwork', trade: 'Brickwork', durations: { 2: 4, 3: 5, 4: 6, 5: 7 }, isKeyStage: true },
  { name: 'Fourth lift scaffold', trade: 'Scaffold', durations: { 2: 1, 3: 1, 4: 1, 5: 2 } },
  { name: 'Roof structure / trusses', trade: 'Roofing', durations: { 2: 3, 3: 3, 4: 4, 5: 5 }, isKeyStage: true },
  { name: 'Gables brickwork', trade: 'Brickwork', durations: { 2: 2, 3: 3, 4: 3, 5: 4 }, isKeyStage: true },
