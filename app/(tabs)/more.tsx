  ...
  return (
    <AppScreen>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Programme Buddy settings, templates and rebuild status.</Text>
      </View>
      ...
      <SectionCard title="Rebuild checklist" subtitle="Current Programme Buddy direction">
        ...
        <Text style={styles.item}>Rolling 2-Week: selected two-week block, stage numbers only.</Text>
